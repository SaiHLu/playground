...
type GreetService_GreetManyTimesClient interface {
	Recv() (*GreetManyTimesRespose, error)
	grpc.ClientStream
}
...
func (x *greetServiceGreetManyTimesClient) Recv() (*GreetManyTimesRespose, error) {
	m := new(GreetManyTimesRespose)
...
type GreetService_GreetManyTimesServer interface {
	Send(*GreetManyTimesRespose) error
	grpc.ServerStream
}
...
func (x *greetServiceGreetManyTimesServer) Send(m *GreetManyTimesRespose) error {
